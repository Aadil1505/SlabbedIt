...
const GITHUB_URL = "https://github.com/Aadil1505/SlabbedIt";

const links = [
  { title: "Preview", href: "/" },
  { title: "GitHub", href: GITHUB_URL },
  { title: "TCGdex", href: "https://tcgdex.dev" },
];

export function SiteFooter() {
  return (
    <footer className="relative z-20 shrink-0 border-t border-border py-12 md:py-16">
      <div className="mx-auto max-w-5xl px-6">
        <Link
          href="/"
          aria-label="go home"
          className="mx-auto flex size-fit items-center gap-2.5"
        >
          <Image
        ...
        <span className="mt-4 block text-center text-sm text-muted-foreground">
          © 2026 SlabbedIt. All rights reserved.
        </span>
      </div>
    </footer>
  );
